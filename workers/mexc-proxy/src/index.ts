...
async function dispatchCommand(
  ...
  if (cmd === 'start') {
    ...
    const welcome =
      channel === 'sniper'
        ? '🎯 <b>ENTERPRISE VANE</b>\n\nСам ищет MICRO high-WR 24/7 (каждую минуту).\nTP 0.45–0.7% · risk 0.35% · WITH HTF · импульс 0.35–0.85%\n💎 MICRO приоритет · иначе WAIT / HOLD\n\nКоманды:\n/zone BTC 94000-96000\n/status · /trades · /journal\n/scan — ручной догон · /stop'
    ...
    if (channel === 'sniper') {
      ...
      await tgSend(
        ...
        [
          ...
          ``,
          `Автопоиск: каждую минуту · MICRO high-WR · WAIT / HOLD`,
